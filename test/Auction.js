...
describe("Auction", function () {
  ...
  before(async () => {
    ...
    console.log("Attack smart contract deployed at: ", attack.address);
  ...
  describe("Auction Contract Working Flow", function () {
    ...
    it("Should fail to become a new leader with amount less than previous leader", async function () {
    ...
    it("Should Become leader with greater amount than previous leader", async function () {
  ...
  describe("Attack Smart Contract", function () {
    describe("Attack on auction smart contract", function () {
      ...
      it('Fail to become a new leader after attack on Auction contract', async () => {
